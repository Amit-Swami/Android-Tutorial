 ...
 */
public class List2Tab2 extends Fragment implements CodeView.OnHighlightListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdView = view.findViewById(R.id.adView28);
